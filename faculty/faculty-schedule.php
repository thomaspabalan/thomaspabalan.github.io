...
<body>
    ...
    <div class ="page">
        ...
        <div class ="sidebar">
            ...
            <button onclick = "schedule()" class ="sidebar-button" href="faculty-schedule.php" title="Go to Schedule Page" style ="background-color: #606060;">
                <p>SCHEDULE</p>
            </button>
        ...
        <div class="main-area">
            <div class = "main-area-header">
                <p style = "width: 80%; text-align: center;">F A C U L T Y&nbsp;&nbsp;&nbsp;S C H E D U L E</p>
            </div>
            <div class="main-area-content-box" style="row-gap: 3%; padding-top: 2.5%; padding-bottom: 2%;">
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="sched-form" class="select-box-button-container">
                    ...
                    <input type="hidden" name="facultyEmailVal" value="<?php echo $email; ?>">
                ...
                <?php
                    if (isset($_POST['changeDay'])) {
                        ...
                        $sql = "SELECT `subject`, `start`, `end`, `room` FROM schedule WHERE professor = (SELECT `name` FROM faculty WHERE facultyEmail = ?) AND `day` = ? ORDER BY `start`";

                        $stmt = $con->prepare($sql);
                        $stmt->bind_param("si", $email, $day);
                        $stmt->execute();
